...
<html>
  ...
  <body>
    ...
    <div class="main">
        ...
        <div class="login">
            <form action="alter_password?op=Login_frame" onsubmit="return checkAll()" method="POST">
                <ul>
                    <li>
                        <div><span>* </span>用户名：</div>
                        <input type="text" required="required" placeholder="学号/手机号" onblur="checkId()" id="id" name="id"> 
                        <span id="idSpan"></span>              
                    </li>
                    <li>
